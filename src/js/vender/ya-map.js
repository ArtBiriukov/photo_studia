(function ymapsInit(e) {
      ...
      (function (e) {
        ...
        return (
          (function (e) {
              ...
              o = (function () {
                ...
                if (e.postMessage) {
                  ...
                  if (a) {
                    ...
                    return (
                      e.addEventListener ? e.addEventListener('message', l, !0) : e.attachEvent('onmessage', l),
                      function (n) {
                        t(n) && e.postMessage(c, '*');
                      }
                    );
            ...
            m.prototype = {
              ...
              _fulfill: function (e) {
                this._status > h.RESOLVED ||
                  ...
                  (this._fulfilledCallbacks = this._rejectedCallbacks = this._progressCallbacks = n));
              },
              _reject: function (e) {
                this._status > h.RESOLVED ||
                  ((this._status = h.REJECTED), (this._value = e), this._callCallbacks(this._rejectedCallbacks, e), (this._fulfilledCallbacks = this._rejectedCallbacks = this._progressCallbacks = n));
              },
              _notify: function (e) {
              ...
              _addCallbacks: function (e, t, r, o, i) {
                ...
                var a;
                this.isRejected() || ((a = { defer: e, fn: s(t) ? t : n, ctx: i }), this.isFulfilled() ? this._callCallbacks([a], this._value) : this._fulfilledCallbacks.push(a)),
                  this.isFulfilled() || ((a = { defer: e, fn: r, ctx: i }), this.isRejected() ? this._callCallbacks([a], this._value) : this._rejectedCallbacks.push(a)),
                  this._status <= h.RESOLVED && this._progressCallbacks.push({ defer: e, fn: o, ctx: i });
              },
            ...
            _.__nextTick__ = o;
            var E = !0;
            'object' == typeof r && 'object' == typeof r.exports && ((r.exports = _), (E = !1)),
      ...
      return (
        ...
        (r.registerImports = function (e, n, t) {
          for (var o = 0; o < n.length; o++)
            if (t[o].__expand) r.registerImports(e, t[o].__expand.depends, t[o].__expand.imports);
            else {
  ...
  r && r.parent && r.parent[r.name] && r.parent[r.name].modules && r.parent[r.name].ready && console.error('(Yandex Maps JS API): api is already enabled on this page with same namespace.'),
    (function () {
      function e(e) {
      ...
      var u,
        c = { transform: 'transform', opacity: 'opacity', transitionTimingFunction: 'transition-timing-function', userSelect: 'user-select', height: 'height' },
        l = {},
        f = {},
    ...
    (function () {
      function e() {
        ...
        var a = s.context;
        0 == a.getParameter(a.MAX_VERTEX_TEXTURE_IMAGE_UNITS) && ((e = !1), n('MAX_VERTEX_TEXTURE_IMAGE_UNITS')),
          a.getExtension('OES_vertex_array_object') || ((e = !1), n('OES_vertex_array_object')),
          a.getExtension('OES_standard_derivatives') || ((e = !1), n('OES_standard_derivatives'));
        var u = a.getShaderPrecisionFormat(a.FRAGMENT_SHADER, a.HIGH_FLOAT);
        if (((u && 0 != u.precision) || ((e = !1), n('highp')), !r())) {
          var c = o();
          (e = !1), t.count('error', { path: ['vectorEngine.drawPointsError', t.env.browser.platform, t.env.browser.name, c.vendor, c.renderer].join('.'), share: 1 });
        }
        return e;
      }
      function n(e) {
        var n = o();
        t.count('error', { path: ['vectorEngine.reasonsVectorNotSupported', e, t.env.browser.platform, t.env.browser.name, n.vendor, n.renderer].join('.'), share: 0.1 });
      }
      function r() {
        var e = document.createElement('canvas');
    ...
    (t.supports.printPatchNeeded = !t.supports.css.checkProperty('printColorAdjust')),
    (t.logger = (function (e) {
      function n(e, n) {
        var r = '';
    ...
    (function () {
      ...
      'MSIE' == e.name || 'IEMobile' == e.name || ('Android' == e.osFamily && 'Gecko' == e.engine) || o || (r > 1 && r < 2) ? (e.graphicsRenderEngine = 'svg') : (e.graphicsRenderEngine = 'canvas'),
        (e.transformTransition = 'Android' == e.osFamily || 'iOS' == e.osFamily || 'MSIE' == e.name || e.isChromium),
        (e.css3DTransform = ('WebKit' == e.engine && !('Android' == e.osFamily && parseFloat(e.osVersion) < 3)) || ('Gecko' == e.engine && parseInt(e.engineVersion.split('.')[0]) >= 10)),
  ...
  var o = (function (e) {
      ...
      function t(e) {
        (this._config = e),
          ...
          (this._initialized = this._remoteLoadingAllowed.promise().then(function () {
      ...
      function c(e) {
        var n = d.isArray(e);
        return 'object' == typeof e && !n && p.call(e, 'modules') ? { modules: d.isArray(e.modules) ? e.modules : [e.modules], data: e.data } : n ? { modules: e } : { modules: [e] };
      }
      var l = { exports: {} },
        f = (l.exports, n('vow')),
        d = n('./ym.utils'),
      ...
      return (
        ...
        (t.prototype._define = function (e) {
          ...
          if (t) {
            ...
            return (
              ...
              (t.storage = e.storage),
              (t.key = e.key),
              e.depends && ('function' == typeof e.depends && (e.depends = e.depends.call({ name: e.name }, this._config.dependenciesContext)), (t.depends = e.depends)),
              (t.dynamicDepends = e.dynamicDepends),
              void (t.exports = e.exports)
            );
          }
          'function' == typeof e.depends && (e.depends = e.depends.call({ name: e.name }, this._config.dependenciesContext)),
        ...
        (t.prototype._resolveCore = function (e, n) {
          return this._fetchModule(e, n)
            ...
            .then(function (n) {
              function t(n, t) {
                e.state === m.RESOLVING && ((e.state = t ? m.ERROR : m.DEFINED), (e.exports = t || n)),
                  o && o.resolve(),
                  t && console.warn('ymaps.modules: provide(undefined, error) is deprecated and will be removed, throw instead. Module `' + e.name + '`.');
              }
              var r, o;
              (t.async = function (n) {
                e.state === m.RESOLVING &&
              ...
              return r
                ...
                ? (console.warn('ymaps.modules: asynchronous provide is deprecated and will be removed. Module `' + e.name + '`.'), (o = f.defer()), o.promise())
                : void 0;
            }, this);
        }),
  ...
  (t.modules = new o({
    ...
    (function (e) {
      function n() {
        ...
        var e = {};
        arguments.length &&
          (1 != arguments.length || 'object' != typeof arguments[0] || arguments[0].length
            ? 'function' != typeof arguments[0]
              ? ((e.require = 'string' == typeof arguments[0] ? [arguments[0]] : arguments[0]),
                (e.successCallback = arguments[1]),
                (e.errorCallback = arguments[2] && 'function' == typeof arguments[2] ? arguments[2] : null),
                (e.context = arguments[2] && 'object' == typeof arguments[2] ? arguments[2] : arguments[3]))
              : ((e.successCallback = arguments[0]),
                (e.errorCallback = arguments[1] && 'function' == typeof arguments[1] ? arguments[1] : null),
                (e.context = arguments[1] && 'object' == typeof arguments[1] ? arguments[1] : arguments[2]))
            : (e = arguments[0]));
        var n = e.require || [],
    ...
    t.env.server.params.csp && !t.supports.csp.isSupported && t.logger.warning('CSP is not suported in this browser'),
    t.modules.define(
      ...
      function (e, n) {
        function r() {
          ...
          return (
            ...
            (r.src = t.env.hosts.vectorIndex.replace('{{version}}', t.env.vectorVersion)),
            t.env.vectorEngineFileName && (r.src = r.src.replace('vector.min.js', t.env.vectorEngineFileName)),
    ...
    t.env.hasValidApiKey || ((t.env.apikey = void 0), 'undefined' != typeof t.env.hasValidApiKey && console.warn('(Yandex Maps JS API): Invalid API key'));
})(
  {
    vectorVersion: '5.21.0',
    vectorVersionTimestamp: 1657717223641,
    flags: [],
    server: { url: 'https://api-maps.yandex.ru/2.1.79', path: 'build/release', params: { mode: 'release', ns: 'ymaps', csp: null }, version: '2.1' },
    ...
    layers: {
      map: { version: '22.07.13-0-b220606200930', scaled: true, hotspotZoomRange: [1, 23], hotspotExcludeByTags: ['admin'] },
      skl: { version: '22.07.13-0-b220606200930', scaled: true, hotspotZoomRange: [1, 23], hotspotExcludeByTags: ['admin'] },
      sat: { version: '3.1022.0' },
      stv: { version: '2022.07.13.12.08-1_22.07.13-0-11791' },
      trf: { version: '1657717020', scaled: true },
      sta: { version: '2022.07.13.12.08-1_22.07.13-0-11791' },
      trfe: { version: '', scaled: true, hotspotZoomRange: [0, 21] },
      carparks: { version: '', scaled: true },
    },
    geolocation: { longitude: 42.09306, latitude: 47.647714, isHighAccuracy: false, span: { longitude: 0.081361, latitude: 0.085879 } },
    token: '38195c6330f1daa15b22b04c5b96b1d7',
    distribution: {},
    version: '2.1.79',
    majorVersion: '2.1',
    ...
    bundles: {
      panoramas: '/release/panoramas-b01220134070100ee2a25a5fb6378d926cebe29e.js',
      full: '/release/full-88ae85a7e79dc2e989989ffba80c9592b8939f11.js',
      PREFIX: 's3/front-maps-static/maps-front-jsapi-v2-1/2.1.79-41/build',
    },
  },
  null
);
